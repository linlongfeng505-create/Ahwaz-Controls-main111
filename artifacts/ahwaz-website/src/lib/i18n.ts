...
const DICTIONARY: Record<Language, Record<string, string>> = {
  en: {
    ...
    "home.categories.desc": "Explore our comprehensive range of industrial instrumentation solutions.",
    "home.cta.title": "Can't find a discontinued part?",
    "home.cta.desc": "Our global sourcing network can locate hard-to-find and obsolete industrial instrumentation. Let our specialists help.",
    ...
    "cat.domon.title": "Domon Valve",
    "cat.domon.desc": "Specialist dome valves for bulk solids, powder, and fly ash conveying systems.",
    "cat.sootblower.title": "Soot Blowers",
    "cat.sootblower.desc": "Industrial soot blowing equipment for boiler and heat exchanger cleaning.",
    ...
    "ind.oil.desc": "Upstream extraction, midstream transport, and downstream refining require rugged, hazardous-area certified instrumentation. We supply explosion-proof pressure transmitters, dome valves, and severe-service control valves.",
    "ind.chem.title": "Chemical Processing",
    "ind.chem.desc": "Corrosive environments demand specialized materials and extreme precision. We source chemical-resistant sensors, smart valve positioners, and dome valves to ensure batch consistency and plant safety.",
    "ind.power.title": "Power Generation",
    "ind.power.desc": "Thermal, nuclear, and renewable power plants rely on critical steam and water cycle monitoring. We provide pressure transmitters, soot blowers, and reliable actuators for continuous operation.",
    ...
    "ind.water.desc": "Environmental monitoring and treatment facilities require robust level measurement and control. We stock reliable pressure transmitters and smart valve positioners for municipal and industrial water management.",
    ...
    "brands.b14": "Clyde Bergemann Dome Valves — specialist isolation valves for bulk solids, powder, fly ash, and granule conveying systems in power, cement, and petrochemical industries.",
    "brands.b15": "Precision rack-and-pinion pneumatic actuators for quarter-turn valve automation.",
  ...
  id: {
    ...
    "home.categories.title": "Kategori Produk",
    "home.categories.desc": "Jelajahi rangkaian lengkap solusi instrumentasi industri kami.",
    "home.cta.title": "Tidak dapat menemukan suku cadang?",
    "home.cta.desc": "Jaringan pengadaan global kami dapat menemukan instrumentasi industri yang sulit ditemukan dan usang. Biarkan spesialis kami membantu.",
    ...
    "cat.domon.title": "Katup Domon",
    "cat.domon.desc": "Katup kubah khusus untuk sistem konveyor material curah, bubuk, dan abu terbang.",
    "cat.sootblower.title": "Peniup Jelaga",
    "cat.sootblower.desc": "Peralatan peniup jelaga industri untuk pembersihan boiler dan penukar panas.",
    ...
    "brands.b14": "Clyde Bergemann Dome Valve — katup isolasi khusus untuk sistem konveying padatan curah, bubuk, abu terbang, dan butiran di industri pembangkit listrik, semen, dan petrokimia.",
    "brands.b15": "Aktuator pneumatik rak-dan-pinion presisi untuk otomatisasi katup seperempat putaran.",
  ...
  vi: {
    ...
    "home.categories.desc": "Khám phá đầy đủ các giải pháp thiết bị đo lường công nghiệp của chúng tôi.",
    "home.cta.title": "Không tìm thấy linh kiện ngừng sản xuất?",
    "home.cta.desc": "Mạng lưới thu mua toàn cầu của chúng tôi có thể tìm kiếm các thiết bị đo lường khó tìm và đã ngừng sản xuất. Hãy để chuyên gia của chúng tôi hỗ trợ.",
    ...
    "cat.domon.title": "Van Domon",
    "cat.domon.desc": "Van vòm chuyên dụng cho hệ thống vận chuyển vật liệu rời, bột và tro bay.",
    "cat.sootblower.title": "Máy Thổi Bồ Hóng",
    "cat.sootblower.desc": "Thiết bị thổi bồ hóng công nghiệp để làm sạch lò hơi và bộ trao đổi nhiệt.",
    ...
    "brands.b14": "Clyde Bergemann Dome Valve — van cô lập chuyên dụng cho hệ thống vận chuyển chất rắn rời, bột, tro bay và hạt trong ngành điện, xi măng và hóa dầu.",
    "brands.b15": "Bộ truyền động khí nén rack-and-pinion chính xác cho tự động hóa van quay một phần tư.",
  ...
  ar: {
    ...
    "home.categories.desc": "استكشف مجموعتنا الشاملة من حلول الأجهزة الصناعية.",
    "home.cta.title": "لا يمكنك العثور على قطعة مقطوعة؟",
    "home.cta.desc": "يمكن لشبكة المشتريات العالمية لدينا تحديد موقع الأجهزة الصناعية التي يصعب العثور عليها والمتقادمة. دع متخصصينا يساعدونك.",
    ...
    "cat.domon.title": "صمامات دومون",
    "cat.domon.desc": "صمامات قبة متخصصة لأنظمة نقل المواد السائبة والمساحيق والرماد المتطاير.",
    "cat.sootblower.title": "منافخ السخام",
    "cat.sootblower.desc": "معدات نفخ السخام الصناعية لتنظيف الغلايات والمبادلات الحرارية.",
    ...
    "brands.b14": "صمامات القبة من Clyde Bergemann — صمامات عزل متخصصة لأنظمة نقل المواد الصلبة السائبة والمسحوق والرماد الطائر والحبيبات في صناعات الطاقة والإسمنت والبتروكيماويات.",
    "brands.b15": "محركات هوائية دقيقة من نوع rack-and-pinion لأتمتة صمامات ربع دورة.",
